...
/** A full-bleed error state with a [message] and a retry action, used for whole-screen failures. */
@Composable
fun RideFlowErrorState(
    message: String,
    ...
    Column(
        ...
        if (onRetry != null) {
            ...
            RideFlowSecondaryButton(label = "Try again", onClick = onRetry)
        }
    }
}
